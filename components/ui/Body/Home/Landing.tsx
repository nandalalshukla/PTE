...
function Landing() {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-10 mt-15 lg:mt-10  w-full">
      ...
      <div className="w-full md:w-1/2 text-center md:text-left px-2 md:px-0">
        ...
        <div>
          <h1 className="text-3xl md:text-6xl font-extrabold leading-tight tracking-tight animate__animated animate__fadeInDown group">
            ...
            <br />
            <span className="inline-block bg-gradient-to-r from-[#5227FF] to-[#8A5CFF] text-white px-4 py-2 rounded-md shadow-md m-2">
              Pass The Excellence!
            </span>
          </h1>
          {/* SUB HEADING */}
        ...
        {/* BUTTONS */}
        <div className="flex flex-col md:flex-row gap-6 justify-center md:justify-start items-center mt-4 animate__animated animate__fadeInLeft">
          <ContactNowButton
            text="Contact Now"
            icon={<IoCall />}
            href="/contact"
      ...
      <div className="w-full md:w-1/2 flex justify-center md:justify-end animate__animated animate__fadeInDown">
        <div
          className="relative w-full max-w-lg md:max-w-4xl lg:max-w-6xl xl:max-w-3xl aspect-video rounded-xl overflow-hidden shadow-lg mt-6"
        >
          <iframe
