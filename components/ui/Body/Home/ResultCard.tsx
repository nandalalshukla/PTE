...
export default function ResultCard({
  ...
  return (
    <figure className="relative flex flex-col items-center justify-center w-full">
      <div className="relative w-full max-w-none sm:w-[320px] md:w-[400px] lg:w-[420px] aspect-[4/5] sm:aspect-[4/5] md:aspect-[4/5] bg-[linear-gradient(135deg,#e5d4ff,#c8a6ff,#9f7bff,#7fa5ff)] dark:bg-[linear-gradient(135deg,#2a2256,#3F3E81,#635F9C)] border-[2px] p-4 rounded-2xl shadow-lg drop-shadow-2xl transition-transform duration-600 hover:scale-103 ease-in-out">
        <img
          src={imageSrc}
          alt={altText}
