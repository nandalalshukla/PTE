...
const ContactNowButton = () => {
  return (
    <Link
      ...
      className="relative group flex items-center gap-3 justify-center bg-transparent text-white p-2 rounded-full overflow-hidden border-2 border-[#5227FF] shadow-lg active:scale-95 hover:opacity-80 transition-all duration-200"
    >
      {/* Infinite shimmer */}
